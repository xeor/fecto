...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Misc.url'
        db.alter_column('serverinfo_misc', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'Misc.url'
        db.alter_column('serverinfo_misc', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
