...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field attributes on 'Server'
        db.create_table('serverinfo_server_attributes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('server', models.ForeignKey(orm['serverinfo.server'], null=False)),
            ('misc', models.ForeignKey(orm['serverinfo.misc'], null=False))
        ))
        db.create_unique('serverinfo_server_attributes', ['server_id', 'misc_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field attributes on 'Server'
        db.delete_table('serverinfo_server_attributes')
