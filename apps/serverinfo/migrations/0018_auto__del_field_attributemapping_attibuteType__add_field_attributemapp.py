...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AttributeMapping.attibuteType'
        db.delete_column('serverinfo_attributemapping', 'attibuteType_id')

        # Adding field 'AttributeMapping.attributeType'
        db.add_column('serverinfo_attributemapping', 'attributeType', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['serverinfo.AttributeType']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AttributeMapping.attibuteType'
        db.add_column('serverinfo_attributemapping', 'attibuteType', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['serverinfo.AttributeType']), keep_default=False)

        # Deleting field 'AttributeMapping.attributeType'
        db.delete_column('serverinfo_attributemapping', 'attributeType_id')
