...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MiscType.multiple_allowed'
        db.add_column('serverinfo_misctype', 'multiple_allowed', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MiscType.multiple_allowed'
        db.delete_column('serverinfo_misctype', 'multiple_allowed')
