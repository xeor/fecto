...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('serverinfo_attributemapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attributeValue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['serverinfo.AttributeValue'])),
            ('attibuteType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['serverinfo.AttributeType'])),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['serverinfo.Server'])),
        ))
        db.send_create_signal('serverinfo', ['AttributeMapping'])

        # Adding model 'AttributeType'
        db.create_table('serverinfo_attributetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id_name', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
        ...
        db.send_create_signal('serverinfo', ['AttributeType'])

        # Adding model 'AttributeValue'
        db.create_table('serverinfo_attributevalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('description', self.gf('django.db.models.fields.TextField')(db_index=True, null=True, blank=True)),
        ))
        db.send_create_signal('serverinfo', ['AttributeValue'])


    def backwards(self, orm):
        
        # Deleting model 'AttributeMapping'
        db.delete_table('serverinfo_attributemapping')

        # Deleting model 'AttributeType'
        db.delete_table('serverinfo_attributetype')

        # Deleting model 'AttributeValue'
        db.delete_table('serverinfo_attributevalue')
    ...
    models = {
        ...
        'serverinfo.attributemapping': {
            ...
            'attibuteType': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['serverinfo.AttributeType']"}),
