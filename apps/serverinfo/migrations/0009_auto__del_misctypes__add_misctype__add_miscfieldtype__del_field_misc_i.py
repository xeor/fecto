...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Misc.infoType'
        db.delete_column('serverinfo_misc', 'infoType_id')

        # Renaming column for 'Misc.name' to match new field type.
        db.rename_column('serverinfo_misc', 'name', 'name_id')
        # Changing field 'Misc.name'
        db.alter_column('serverinfo_misc', 'name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['serverinfo.MiscType']))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Misc.infoType'
        db.add_column('serverinfo_misc', 'infoType', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['serverinfo.MiscTypes']), keep_default=False)

        # Renaming column for 'Misc.name' to match new field type.
        db.rename_column('serverinfo_misc', 'name_id', 'name')
        # Changing field 'Misc.name'
        db.alter_column('serverinfo_misc', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
