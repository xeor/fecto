...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Server.virtual'
        db.delete_column('serverinfo_server', 'virtual')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Server.virtual'
        db.add_column('serverinfo_server', 'virtual', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
