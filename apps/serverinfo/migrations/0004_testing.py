...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('serverinfo_manycase', (
            ...
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['serverinfo.Case'])),
    ...
    models = {
        ...
        'serverinfo.manycase': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['serverinfo.Case']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'})
        },
        'serverinfo.misc': {
